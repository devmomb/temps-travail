    ...
    <div style={{minHeight:"100vh",background:"#0A0A0A",color:"#E8E4DF",fontFamily:"'DM Mono','Courier New',monospace",fontSize:13}}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        input,select{background:#161616;border:1px solid #2A2A2A;color:#E8E4DF;font-family:'DM Mono',monospace;font-size:12px;padding:7px 10px;border-radius:3px;outline:none;transition:border .15s}
        input:focus,select:focus{border-color:#E86C3A}
        input::placeholder{color:#444}
        select option{background:#161616;color:#E8E4DF}
        button{cursor:pointer;font-family:'Barlow Condensed',sans-serif;font-weight:700;border:none;transition:all .15s;letter-spacing:.04em}
        .btn-p{background:#E86C3A;color:#000;padding:7px 16px;border-radius:3px;font-size:12px;text-transform:uppercase}
        .btn-p:hover{background:#FF8050}
        .btn-g{background:transparent;color:#777;padding:5px 12px;border-radius:3px;font-size:11px;border:1px solid #2A2A2A;text-transform:uppercase}
        .btn-g:hover{border-color:#555;color:#E8E4DF}
        .btn-d{background:transparent;color:#8a3030;padding:2px 7px;border-radius:2px;font-size:10px;border:1px solid #2A1010}
        .btn-d:hover{background:#1a0808;color:#E84040}
        .srow{display:grid;grid-template-columns:80px 52px 52px 58px 70px 1fr 30px;gap:5px;align-items:center;padding:8px 10px;border-bottom:1px solid #151515;font-size:11px}
        .srow:hover{background:#111}
        ::-webkit-scrollbar{width:3px}::-webkit-scrollbar-thumb{background:#252525}
        .client-hdr{padding:6px 8px;display:flex;align-items:center;gap:6px;cursor:pointer;border-radius:3px;transition:background .1s;user-select:none}
        .client-hdr:hover{background:#161616}
        .proj-row{padding:5px 8px 5px 22px;display:flex;align-items:center;gap:6px;cursor:pointer;border-radius:3px;transition:background .1s}
        .proj-row:hover{background:#141414}
        .proj-row.on{background:#161616;border-left:2px solid #E86C3A44}
        @keyframes pulse{0%,100%{transform:scale(1);opacity:.5}50%{transform:scale(1.16);opacity:.18}}
        @keyframes blink{0%,100%{opacity:1}50%{opacity:.5}}
        .tab-btn{padding:5px 14px;border-radius:3px;font-size:11px;border:1px solid #222;background:transparent;color:#666;text-transform:uppercase;letter-spacing:.06em}
        .tab-btn:hover{color:#E8E4DF;border-color:#444}
        .tab-btn.on{background:#E86C3A;color:#000;border-color:#E86C3A}
        .mode-btn{padding:4px 12px;border-radius:2px;font-size:10px;border:1px solid #222;background:transparent;color:#555;text-transform:uppercase;letter-spacing:.06em}
        .mode-btn:hover{color:#E8E4DF}
        .mode-btn.on{background:#252525;color:#E8E4DF;border-color:#444}
        .cal-cell{width:100%;aspect-ratio:1;border-radius:4px;display:flex;flex-direction:column;align-items:center;justify-content:center;font-size:10px;cursor:default;transition:all .1s}
